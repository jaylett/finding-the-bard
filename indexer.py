...
#
# A document is at scene level, with document data in omega format, with
# the following fields:
#   play, act, scene, filename
#
...
def get_db(): # Singleton
    global _db
    if _db==None:
        _db = xapian.WritableDatabase('shakespeare', xapian.DB_CREATE_OR_OPEN)
    return _db
